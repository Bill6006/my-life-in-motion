...
- Build once, test the frozen artifact, verify hashes and deploy that exact artifact. Do not rebuild between browser tests and deployment.
- Use the public repository and permanent URL already configured here. Keep every phase’s deployed version in the private progress ledger and wait for the owner’s Green or Yellow.
